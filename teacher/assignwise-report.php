...
<head>
    ...
    <title>SUBMITO : Subject Wise Report </title>
            ...
            <div class="container-fluid">
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Assignment Wise Report Information</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div id="main-content">
                    <div class="card alert">
                        <div class="card-body">
                            <form name="" method="post" action="assignwise-report-assin.php" enctype="multipart/form-data">
            ...
            <option value="<?php  echo htmlentities($row->subid);?>"><?php  echo htmlentities($row->SubjectFullname);?>(<?php  echo htmlentities($row->SubjectCode);?>)</option><?php $cnt=$cnt+1;}} ?>
                                ...
                                <div class="col-md-4">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            <label>Subject</label>
                                            <select class="form-control border-none input-flat bg-ash" name="assid" required="true">
            <option value="">Select Subject</option>
            <?php
     $tid=$_SESSION['ocastid'];
$sql="SELECT tblassignment.AssignmentNumber,tblassignment.ID as asssid,tblassignment.AssignmentNumber from tblassignment
join tblsubject on tblsubject.ID=tbluploadass.Sid 
join tbluploadass on tbluploadass.Sid=tblsubject.ID 
where tblteacher.ID=$tid";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
