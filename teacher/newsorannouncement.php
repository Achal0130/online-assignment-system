...
$sql="insert into tblnewsbyteacher(ProfessorID,Title,Description)values(:tid,:title,:desc)";
...
<head>
    ...
    <title>SUBMITO : News or Announcement</title>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table student-data-table m-t-20">
                                            ...
                                            <tbody>
                                                <?php
                                                $tid=$_SESSION['ocastid'];
$sql="SELECT * from tblnewsbyteacher where ProfessorID=:tid";
$query = $dbh -> prepare($sql);
$query->bindParam(':tid',$tid,PDO::PARAM_STR);
$query->execute();
