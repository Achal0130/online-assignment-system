...
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 $query->execute();
    ...
    echo '<script>alert("Professor detail has been updated.")</script>';
...
<head>
    ...
    <title>SUBMITO : Update Professor Information </title>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Professor Information</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="basic-form">
                                        <div class="form-group image-type">
                                            <label> Professor Photo <span>(150 X 150)</span></label>
