			...
			<header>
				...
				<div class="header-bottom-w3layouts">
					<div class="main-w3ls-logo">
						<h1><a href="index.php"><span class="fa fa-solid fa-check" aria-hidden="true"></span>SUBMITO</a></h1>
					</div>
					<!-- navigation -->
					...
					<span class="icon-bar"></span>
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li><a href="teacher/login.php">Professor</a></li>
...
{               ?>
	...
	<div class="footer-agileits-w3layouts">
		<div class="container">
			<div class="btm-logo-w3ls">
				<h2><a href="index.html"><span class="fa fa-solid fa-check" aria-hidden="true"></span>SUBMITO</a></h2>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
	<div class="copyright-w3layouts">
		<div class="container">
			<p>&copy; 2023 SUBMITO . Online College Assignment System | </p>
		</div>
	</div>
	<!-- //Footer -->
